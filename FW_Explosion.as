...
void pixelsparks(Vec2f at, CBlob@ this)
{
    ...
    */
    ...
    {  
        ...
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(0, 1+XORRandom(3), 360);
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(0, 5+XORRandom(3), 360);
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(0, 8+XORRandom(3), 360);
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(0, 13+XORRandom(3), 360);
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(0, 17+XORRandom(3), 360);
    ...
    if (type == 5) // big round perfect spacing
    {  
        SetScreenFlash( 10, presetcolor1.getRed(), presetcolor1.getGreen(), presetcolor1.getBlue(), 2.75f );
        ShakeScreen( 50, 10, this.getPosition() );
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(i*15, 1+XORRandom(4), 1);
            CParticle@ p1 = ParticlePixel( at, vel,  presetcolor1, true );
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(i*15, 5+XORRandom(5), 10);
            CParticle@ p2 = ParticlePixel( at, vel, presetcolor2, true );
            if(p2 is null) return;
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(i*15, 10+XORRandom(5), 1);
            CParticle@ p3 = ParticlePixel( at, vel, presetcolor3, true );
            if(p3 is null) return;
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(i*15, 15+XORRandom(5), 1);
            CParticle@ p4 = ParticlePixel( at, vel, presetcolor4, true );
            if(p4 is null) return;
        ...
        for (int i = 0; i < amount; i++)
        {
            Vec2f vel = this.getVelocity() + getRandomVelocity(i*15, 20+XORRandom(5), 1);
            CParticle@ p5 = ParticlePixel( at, vel, presetcolor5, true );
            if(p5 is null) return;
